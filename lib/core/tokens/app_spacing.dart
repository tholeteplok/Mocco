...
/// Centralized spacing, dimensions, and radii for Mocco Design System (v1.5)
/// Based on 8dp grid system (V2), large touch targets (V0.5), and soft corners (V3).
abstract final class AppSpacing {
  ...
  // Inter-card minimum spacing (V20)
  static const double cardGap = 16.0;

  // Touch targets (V0.5: Minimum 64x64dp)
  ...
  // Border Radii (V3: Minimum radius 12dp)
