...
import '../map/map_node_button.dart';

/// 3D Clay Stepping Stone for Adventure Map (Pinterest Diorama Aesthetic)
/// Resembles a tactile, rounded plasticine pebble on an adventure pathway.
class ClaySteppingStone extends StatefulWidget {
  const ClaySteppingStone({
    super.key,
    required this.label,
  ...
  @override
  State<ClaySteppingStone> createState() => _ClaySteppingStoneState();
}

class _ClaySteppingStoneState extends State<ClaySteppingStone>
  ...
  @override
  void didUpdateWidget(ClaySteppingStone oldWidget) {
          ...
          gradient: RadialGradient(
            ...
            colors: [
              HSLColor.fromColor(stoneColor)
                  .withLightness((HSLColor.fromColor(stoneColor).lightness + 0.12).clamp(0.0, 1.0))
                  .toColor(),
              stoneColor,
              HSLColor.fromColor(stoneColor)
